...
function displayUserData(user) {
  ...
  if (user.blog) {
    blogContainer.innerHTML = `
      ...
      <a id="blog" href="${user.blog.startsWith("http") ? user.blog : `https://${user.blog}`}" target="_blank">${user.blog}</a>
    `;
  } else {
    blogContainer.innerHTML = `
      <i class="fas fa-link"></i>
  ...
  if (user.twitter_username) {
    twitterContainer.innerHTML = `
      ...
      <a id="twitter" href="https://twitter.com/${user.twitter_username}" target="_blank">@${user.twitter_username}</a>
    `;
  } else {
    twitterContainer.innerHTML = `
      <i class="fab fa-twitter"></i>
